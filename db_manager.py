...
from config import DATA_DIR, DB_CONFIG_FILE, DEFAULT_MYSQL_CONFIG
    ...
    def execute_query(self, sql: str, params = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if params is None:
                ...
                logger.warning("执行SQL查询时参数为字典类型，无法直接使用，将使用空参数")
                params = ()
    ...
    def execute_update(self, sql: str, params = None) -> int:
        ...
        try:
            ...
            if params is None:
                ...
                logger.warning("执行SQL更新时参数为字典类型，无法直接使用，将使用空参数")
                params = ()
    ...
    def execute_insert(self, sql: str, params = None) -> int:
        ...
        try:
            ...
            if params is None:
                ...
                logger.warning("执行SQL时参数为字典类型，无法直接使用，将使用空参数")
                params = ()
