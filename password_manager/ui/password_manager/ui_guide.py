...
MAIN_FEATURES_WALKTHROUGH = [
    ...
    {
        "title": "右键菜单（除密码列）",
        "description": "在除密码列上右击可显示操作菜单，支持复制内容以及添加、编辑、查看历史密码修改记录和删除记录功能。\n\n右键菜单包含：\n· 复制 - 快速复制单元格内容到剪贴板\n· 添加行 - 新增一条密码记录\n· 编辑行 - 修改当前选中的记录\n· 查看历史密码 - 显示该条目的历史修改记录，可查看修改时间、内容和操作人\n· 删除行 - 移除当前选中的记录\n\n注意：实际使用时可在任意（除了密码列）的单元格右击，操作将应用于整行记录。",        "position": "menu_bottom",
    ...
    {
        "title": "右键菜单（密码列）",
        "description": "在密码列上右击可显示操作菜单，包括复制密码和生成随机密码等功能。\n\n右键菜单包含：\n· 复制 - 快速复制密码内容到剪贴板\n· 生成16位随机密码并更新到服务器 - 自动生成高强度密码并同步更新\n· 添加行 - 新增一条密码记录\n· 编辑行 - 修改当前选中的记录\n· 查看历史密码 - 显示该密码的历史修改记录，可查看修改时间、内容和操作人\n· 删除行 - 移除当前选中的记录\n\n支持多选操作，批量更新服务器密码。可同时选择多条记录，右击后批量生成和更新密码，提高工作效率。",        "position": "menu_bottom",
        "show_menu_image": True,  # 使用图片显示菜单
        "widget_id": "password_table",
