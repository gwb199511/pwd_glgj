...
from features.audit.audit_log import AuditLogger, OP_TYPE_LOGIN, OP_TYPE_LOGOUT, OP_RESULT_SUCCESS, OP_RESULT_FAIL, LOG_TYPE_LOGIN
...
class UserManager:
    ...
    def _initialize(self):
        ...
        from core.data_storage import get_user_storage, get_remember_storage
